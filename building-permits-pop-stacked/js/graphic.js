...
var renderStackedBarChart = function(config) {
     ...
     */
     ...
     var colorScale = d3.scale.ordinal()
         .domain(['2000children','2000adults','2014children','2014adults'])
         .range([ COLORS['teal3'], COLORS['teal4'],COLORS['orange3'], COLORS['orange4'] ]);
    ...
    var legend = containerElement.append('ul')
		.attr('class', 'key')
		.selectAll('g')
			.data(labels.concat(colorScale.domain()))
		.enter().append('li')
