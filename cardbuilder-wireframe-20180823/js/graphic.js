...
var buildBaseURL = function() {
    if (document.location.hostname === 'cardbuilder.wbez.org') {
        return 'https://cardbuilder.wbez.org/cardbuilder/';
    } else {
        // for newer cards
        return 'https://s3.amazonaws.com/cardbuilder-stage/cardbuilder/';
