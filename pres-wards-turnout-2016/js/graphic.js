...
var renderMap = function(config) {
    ...
    // var color_diff = d3.scale.quantize()
    //     .domain([min('turnout_diff'), max('turnout_diff')])
    //     .range(['#762a83','#9970ab','#c2a5cf','#e7d4e8','#d9f0d3','#a6dba0','#5aae61','#1b7837']);
    ...
    //     .data(color_diff.range());

    // keys.enter().append('li')
    //     .attr('class', 'key')
    //     .style('border-top-color', String)
    //     .text(function(d) {
    //         var r = color_diff.invert(d);
    //         return pct(r[0]);
    //     });
