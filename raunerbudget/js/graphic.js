...
var VALUE_MIN_WIDTH = 100;
var money = d3.format('$.3s');
var millions = d3.format('$s')
    ...
    if (Modernizr.svg) {
        ...
        d3.csv(GRAPHIC_DATA_URL, function(error, data) {
            ...
            color = d3.scale.ordinal()
                .range([colors['blue3'], colors['blue5'], colors['red3']])
...
var drawGraph = function(graphicWidth) {
    ...
    var xAxis = d3.svg.axis()
        ...
        .tickFormat(function(d) {
            return millions(d).replace('G', ' million');
        });
    ...
    barGroup.append('g')
        ...
        .enter().append('text')
            ...
            .text(function(d) {
                ...
                return money(d['amt']).replace('G', ' billion').replace('M', ' million');
            });
